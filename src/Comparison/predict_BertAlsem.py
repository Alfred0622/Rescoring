...
checkpoint = torch.load(f'./checkpoint/withLM/20/checkpoint_train_best.pt')
...
for task in recog_set:
    ...
    with open(file_name ,'r') as f:
        ...
        with open(f"./data/{args['dataset']}/{task}/{setting}/alsem/{args['nbest']}best/rescore_data.json", 'w') as f:
